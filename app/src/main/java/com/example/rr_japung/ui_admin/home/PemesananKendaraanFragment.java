...
//    private TextView TextViewNamaSupir,TextViewNoTeleponSupir,TextViewHargaPaketSupir;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View root = inflater.inflate(R.layout.admin_ui_fragment_pemesanan_kendaraan, container, false);
        ...
        TextViewNoKendaraan.setText(AdminActivity.reference_key_no_kendaraan);
        ...
        TextViewPaketSupir.setOnClickListener(new View.OnClickListener(){
            ...
            public  void  onClick(View v){
                ...
                mAdapterSopir.setOnItemClickListener(PemesananKendaraanFragment.this);
        ...
        ButtonPesanSekarang .setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (PaketHargaSupir==0){
                    Transaksi dataTransaksi = new Transaksi(AdminActivity.merk_kendaraan.trim(),
                            AdminActivity.tipe_kendaraan.trim(),
                            AdminActivity.reference_key_no_kendaraan.trim(),
                            AdminActivity.tahun_produksi,
                            AdminActivity.ukuran_mesin,
                            AdminActivity.harga_sewa.trim(),
                            AdminActivity.transmisi,
                            AdminActivity.mesin,
                            AdminActivity.imageURL,
