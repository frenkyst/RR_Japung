...
public class KeranjangPesanan extends RecyclerView.Adapter<KeranjangPesanan.DaftarTransaksiViewHolder>{
    private Context mContext;
    private List<Transaksi> mDataTransaksi;
    private KeranjangPesanan.OnItemClickListener mListener;

    public KeranjangPesanan(Context context, List<Transaksi> dataTransaksi) {
        mContext = context;
        mDataTransaksi = dataTransaksi;
    }

    @Override
    public KeranjangPesanan.DaftarTransaksiViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.list_view_keranjang_pesanan, parent, false);
        return new KeranjangPesanan.DaftarTransaksiViewHolder(v);
    }

    @Override
    public void onBindViewHolder(KeranjangPesanan.DaftarTransaksiViewHolder holder, int position) {
...
//        void onDeleteClick(int position);
    ...
    public void setOnItemClickListener(KeranjangPesanan.OnItemClickListener listener) {
        mListener = listener;
    }
}
